...
!ars599: 01042014: use cice4.1 mpi ice_communicate otherwise
!	will have MPI_Comm_f2c issue
!04042014: this part was copied from ACCESS-OM cice4.1
!	add in key_oasis3mct and try again.
!04092014: AusCOm didnt use this bit. MPI_INIT will calll in OASIS
!	only use master_task = 0
#ifndef AusCOM
