...
!ars599: 09042014: changed no more else extreme_test = .false.
!	through extreme_test is in cpl_parameters
!	somehow gives error message, (use cpl_parameters)
!	This name does not have a type, and must have an explicit type.   [EXTREME_TEST]
      logical (kind=log_kind), parameter :: &
#ifndef AusCOM
