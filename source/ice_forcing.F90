...
#ifdef AusCOM
!ars599: 27032014: add in get_forcing_atmo_ready
...
!ars599: 26032014 (CODE: const)
!	since auscom will call oasis related subroutine
!	which will use some constants from ice_constants
!	no need to add #ifdef AusCOM cuz such subroutines
!	are in #ifdef AusCOM  already.

      use ice_constants, only: c0, c10
