!  SVN:$Id: ice_history.F90 745 2013-09-28 18:22:36Z eclare $
!=======================================================================
...
!ars599: 27032014 
!	was in subroutine ice_write_hist of ice_history_write
!	but seems to be here rather than subroutine ice_write_hist
!	new code set in ice_constants
!      use ice_shortwave, only: awtvdr, awtidr, awtvdf, awtidf
!      use ice_constants, only: awtvdr, awtidr, awtvdf, awtidf
!	however since already used at line #1145 so mark out
#endif
